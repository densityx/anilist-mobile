...
import {IconPencil, IconUserCircle} from "tabler-icons-react-native";
                    ...
                    <>
                        <Card styles={'flex items-center'}>
                            <View style={tailwind('relative flex items-center w-full')}>
                                <View style={tailwind('absolute right-0 top-0 flex flex-row')}>
                                    <TouchableOpacity
                                        onPress={() => setEditMode(!editMode)}
                                        style={tailwind('px-3 py-2 rounded-full bg-zinc-700')}
                                    >
